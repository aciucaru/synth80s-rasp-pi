#ifndef SYNTH80S_SRC_AUDIO_OSCILLATOR_SQUARE_OSCILLATOR_H

#define SYNTH80S_SRC_AUDIO_OSCILLATOR_SQUARE_OSCILLATOR_H
...
namespace synth80s
{
  class SquareOscillator: public MelodicOscillator
  {
    public:
      // constructor, must receive AudioContext as external dependecy
      SquareOscillator(AudioContext* audioContext);
